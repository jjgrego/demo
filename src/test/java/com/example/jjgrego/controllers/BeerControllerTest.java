...
import com.example.jjgrego.services.BeerServiceImpl;
...
class BeerControllerTest {
    ...
    void testCreateNewBeer() throws Exception {
        ...
        given(beerService.addNewBrand(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null, false, 1, 25).getContent().get(1));
    ...
    void testCreateBeerNullBeerName() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(post(BeerController.BEER_PATH)
                        .with(httpBasic("numbnutz", "password"))
                        .accept(MediaType.APPLICATION_JSON)
                        .contentType(MediaType.APPLICATION_JSON)
